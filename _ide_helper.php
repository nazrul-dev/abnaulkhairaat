...
')
     ...
     */ 
         ...
         * @static 
         */ 
        public static function getInstruksiPembayaran($code, $payCode = null, $amount = null, $allowHtml = 1)
        {
                        /** @var \Nekoding\Tripay\Tripay $instance */
                        return $instance->getInstruksiPembayaran($code, $payCode, $amount, $allowHtml);
        }
                    /**
         * 
         *
         ...
         * @static 
         */ 
        public static function getChannelPembayaran($code = null)
        {
                        /** @var \Nekoding\Tripay\Tripay $instance */
                        return $instance->getChannelPembayaran($code);
        }
                    /**
         * 
         *
         ...
         * @static 
         */ 
        public static function getBiayaTransaksi($amount, $code = null)
        {
                        /** @var \Nekoding\Tripay\Tripay $instance */
                        return $instance->getBiayaTransaksi($amount, $code);
        }
                    /**
         * 
         *
         ...
         * @static 
         */ 
        public static function getDaftarTransaksi($data = [])
        {
                        /** @var \Nekoding\Tripay\Tripay $instance */
                        return $instance->getDaftarTransaksi($data);
        }
                    /**
         * 
         *
         ...
         * @return \Nekoding\Tripay\Transactions\Transaction 
         ...
         * @static 
         */ 
        public static function createTransaction($data, $transactionType = 'close')
        {
                        /** @var \Nekoding\Tripay\Tripay $instance */
                        return $instance->createTransaction($data, $transactionType);
        }
                    /**
         * 
         *
         ...
         * @static 
         */ 
        public static function getDetailTransaction($id, $transactionType = 'close')
        {
                        /** @var \Nekoding\Tripay\Tripay $instance */
                        return $instance->getDetailTransaction($id, $transactionType);
        }
                    /**
         * Load configuration
         *
         ...
         * @static 
         */ 
        public static function loadConfig($isProduction, $apiKey, $privateKey, $merchantCode)
        {
                        \Nekoding\Tripay\Tripay::loadConfig($isProduction, $apiKey, $privateKey, $merchantCode);
        }
...
namespace  { 
            ...
            class Tripay extends \Nekoding\Tripay\TripayFacade {}
